...
const ProjectsSection = () => {
    return (
        ...
        >
            <h2 style={{ fontSize: "4rem", marginBottom: "40px", color: "#333" }}>
                Projects
            </h2>
            <div
                style={{
