  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hello, I'm Carter Awbrey, a passionate software engineer dedicated to
          solving complex problems. Originally from Muscatine, Iowa, I am
          currently a senior at Iowa State University, pursuing a degree in
          Software Engineering.
          <br />
          My enthusiasm for technology extends far beyond software—it has been a
          lifelong passion. I currently work as a professional software
          engineer, primarily developing Android applications and maintaining
          server-side code written in .NET.
          <br />
          While I enjoy all aspects of software development, I have a particular
          interest in backend systems and infrastructure. I thrive on the
          constant learning and problem-solving challenges that come with this
          field, and I am always eager to expand my knowledge and skill set.
        </p>
      </div>
